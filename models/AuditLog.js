...
const AuditLogSchema = new mongoose.Schema({
  action: {
    ...
    required: true,
      ...
      ,'FINANCE_LETTER_SUBMISSION_FAILED','FINANCE_LETTER_SUBMITTED','FINANCE_LETTER_VERIFICATION_FAILED','FINANCE_LETTER_VERIFIED','FINANCE_LETTER_RESUBMITTED','KYC_RESUBMITTED','APPROVE','UNFREEZE_USER','EXTEND_DEADLINE','VIEW_UPDATE_FORM'
    ]
  },
  entity: {
    type: String,
